...
- **LED пръстен (WS2812B)**  
  Свържете DATA IN (DIN) пина на пръстена към **GPIO 13** на ESP32.  
  Захранване:
  - **VCC** → 5V  
  - **GND** → GND

- **Бутон за смяна на режимите**  
  Свържете единия крак на бутона към **GPIO 14**, а другия – към **GND**.  

> При всяко натискане на бутона системата превключва към следващия режим на визуализация.
...
1. Свържете китарата към аудио интерфейса
...
7. За смяна на режима, натиснете бутона. 
